...
namespace PhanMemCamDo.Controllers.Api
{
    ...
    [ApiController]
    public class PaymentHistoriesApiController(PawnShopDbContext context) : ControllerBase
    {
        // GET: api/PaymentHistoriesApi
        [HttpGet]
        public async Task<ActionResult<IEnumerable<PaymentHistory>>> GetPaymentHistories()
        {
            return await context.PaymentHistories.ToListAsync();
        }
        ...
        {
            var paymentHistory = await context.PaymentHistories.FindAsync(id);
        ...
        public async Task<IActionResult> DeletePaymentHistory(int id)
        {
            ...
            context.PaymentHistories.Remove(paymentHistory);
            await context.SaveChangesAsync();
        ...
        {
            return context.PaymentHistories.Any(e => e.Id == id);
        }
    }
}
